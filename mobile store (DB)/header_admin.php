        ...
        <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: rgb(240,240,240)">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav m-auto font-rubik">
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="#dep">All products</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="#adp">Add Product</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link text-dark" href="#adi">Additional Information</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="#alo">Orders</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="#qqqq">Messages</a>
                    </li>
                </ul>
