...
<body>
    ...
    <p class="font-rale font-size-16 text-white m-0"
    style="padding: 5px; text-align: center; font-size: 16px;">
        This is Our mobile shop
    </p>
    <div class="font-rale font-size-14"
    style="padding: 5px; text-align: center; font-size: 16px; margin-left: 10px; 
    color: black;">
    <?php
...
?>
        ...
        <!-- Primary Navigation -->
        <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: rgba(66, 66, 69, 0.7);">
